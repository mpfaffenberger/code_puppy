...
async def main():
    ...
    async with async_playwright() as playwright:
        ...
        await page.goto("https://developer.microsoft.com/en-us/graph/graph-explorer", timeout=30000)
        ...
        for cookie in cookies:
            if 'token' in cookie['name'].lower() or 'auth' in cookie['name'].lower() or 'msal' in cookie['name'].lower():
                print(f"\n{cookie['name']}:")
                value = cookie['value']
