...
This doc describes exactly what appears when you run the `/show` console command. This helps with debugging, development, and UI validation.

## What `/show` Prints

The `/show` command displays the following puppy status variables to your console (with colors/formatting via `rich`):
