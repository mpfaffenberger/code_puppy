...
class TestAgentCommand:
    ...
    def test_agent_command_list(
        ...
        # Mock descriptions
        mock_descriptions.return_value = {"code-puppy": "The most loyal digital puppy"}
    ...
    def test_agent_command_switch_valid(
        self,
        mock_get_agent,
        mock_current_config,
        mock_set_agent,
    ...
    @patch("code_puppy.agents.set_current_agent")
    @patch("code_puppy.agents.get_available_agents")
    def test_agent_command_switch_invalid(
        self, mock_available, mock_set_agent, mock_warning, mock_error
    ):
