...
from code_puppy.message_history_processor import stringify_message_part, estimate_tokens_for_message, summarize_message
...
def test_stringify_message_part_with_content_and_tool_call():
    part = MockPart(content="Hello, world!", tool_name="test_tool", args={"param": "value"})
    result = stringify_message_part(part)
...
def test_summarize_message_with_tool_call(mock_get_summarization_agent):
    ...
    from pydantic_ai.messages import ModelRequest, ToolCallPart, TextPart
