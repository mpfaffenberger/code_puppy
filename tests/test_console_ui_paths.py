from code_agent.tools.command_runner import share_your_reasoning
...
# This test calls share_your_reasoning with both arguments

def test_share_your_reasoning_next_steps():
    out = share_your_reasoning({}, reasoning="Step", next_steps="Dance!")
    assert out['success']

# This triggers tree output for multi-depth directories

def test_list_files_multi_level_tree():
    with patch('os.path.abspath', return_value='/foo'), \
