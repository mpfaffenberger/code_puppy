...
def test_agent_orchestrator_loads_with_new_tools():
    ...
    # Verify file exists
    assert os.path.exists(orchestrator_path), f"Agent orchestrator file not found at {orchestrator_path}"
    ...
    assert agent.description == "Coordinates and manages various specialized agents to accomplish tasks"
