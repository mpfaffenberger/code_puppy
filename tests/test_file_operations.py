...
def test_create_file():
    ...
    with patch("os.path.exists") as mock_exists, patch("builtins.open", m), patch("os.makedirs") as mock_makedirs:
...
def test_read_file():
    ...
    with patch("os.path.exists") as mock_exists, patch("os.path.isfile") as mock_isfile, patch("builtins.open", m):
