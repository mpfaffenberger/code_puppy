...
all_types = [
    "main.py", "frontend.js", "component.tsx", "layout.html", "styles.css", "README.md", "config.yaml", "image.png",
    "music.mp3", "movie.mp4", "report.pdf", "archive.zip", "binary.exe", "oddfile.unknown"
]

def test_list_files_get_file_icon_full_coverage():
    fake_entries = [("/repo", [], all_types)]
    with patch("os.path.abspath", return_value="/repo"), \
