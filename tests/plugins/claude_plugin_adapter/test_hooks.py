...
def test_hooks_expansion(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("code_puppy.plugins.claude_code_hooks.config.GLOBAL_HOOKS_FILE", str(mock_hooks_file))
    monkeypatch.setattr("code_puppy.plugins.claude_code_hooks.config.PROJECT_HOOKS_FILE", "nonexistent.json")
