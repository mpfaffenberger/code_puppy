...
class TestSkillDiscovery:
    ...
    def test_get_default_skill_directories(self):
        ...
        assert directories[1] == Path.home() / ".claude" / "skills"
        assert directories[2] == Path.home() / ".wibey" / "skills"
        assert directories[3] == Path.cwd() / "skills"
...
class TestSkillsConfig:
    ...
    def test_get_skill_directories_default(self, monkeypatch):
        ...
        assert ".claude/skills" in directories[1]
        assert ".wibey/skills" in directories[2]
        # The current directory path will contain the full path, ending with "skills"
        assert "skills" in directories[3]
    ...
    def test_get_skill_directories_malformed_config(self, monkeypatch, caplog):
        ...
        assert len(directories) == 4  # Falls back to defaults
