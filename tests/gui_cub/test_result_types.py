...
class TestKeyboardActionResult:
    ...
    def test_can_create_with_text(self):
        ...
        result = KeyboardActionResult(success=True, text_length=5, preview="Hello")
    ...
    def test_can_create_with_hotkey(self):
        ...
        result = KeyboardActionResult(
            success=True, hotkey="Cmd+C", keys=["Cmd", "C"], platform="macOS"
        )
...
class TestElementInfo:
    ...
    def test_can_create_with_platform_specific_fields(self):
        ...
        element = ElementInfo(
            control_type="Button", class_name="WinButton", auto_id="btn_submit"
        )
...
class TestScreenshotResult:
    ...
    def test_can_create_with_path(self):
        ...
        result = ScreenshotResult(
            success=True, screenshot_path="/tmp/screenshot.png", width=1920, height=1080
        )
    ...
    def test_screenshot_data_excluded_from_serialization(self):
        ...
        result = ScreenshotResult(success=True, screenshot_data=b"fake_image_data")
