...
class TestCommandHistoryManager:
    ...
    def test_malformed_history_handling(self):
        ...
        try:
            ...
            expected = ["valid command 1", "orphaned command without timestamp", "valid command 2"]
...
class TestPromptToolkitIntegration:
    ...
    def test_create_prompt_toolkit_history_file(self):
        ...
        try:
            ...
            with patch('code_puppy.command_line.history_manager.get_history_manager') as mock_get_manager:
    ...
    def test_custom_text_area_history_state(self):
        ...
        with patch('code_puppy.command_line.history_manager.get_history_manager') as mock_get_manager:
            ...
            mock_manager.get_recent_commands.return_value = [
                "recent command 1", "recent command 2"
            ]
            mock_get_manager.return_value = mock_manager
