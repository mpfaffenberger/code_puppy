...
Sets up the flux `config.env` (`~/.flux/<flattened-dir>/config.env` for stable, `~/.flux-nightly/<flattened-dir>/config.env` for nightly) with your test command, Jira settings, and ticket prefix.
...
0. //flux/create-jira <summary (title) of the ticket>
...
4. //flux/aug <task-file> or //flux/aug <N>
5. //flux/exec <task-file> or //flux/exec <N>
6. //flux/qa <task-file> or //flux/qa <N>
7. //flux/tests
8. //flux/commit
...
2. Share the zip file created (e.g. `~/.flux/<flattened-dir>/review.zip` or `~/.flux-nightly/<flattened-dir>/review.zip`) with PR author (post on the PR, Slack, etc.)
...
| Create Jira ticket   | //flux/create-jira <summary or title of the ticket> |
...
| Research & augment   | //flux/aug <task-file\|N>                           |
| Execute task(s)      | //flux/exec <task-file\|N>                          |
| QA review            | //flux/qa <task-file\|N>                            |
...
| View Looper CI job   | //flux/view-looper <PR#>                            |
| Full pipeline        | //flux/auto-pilot <prompt \| spec.md \| TICKET-ID>  |
