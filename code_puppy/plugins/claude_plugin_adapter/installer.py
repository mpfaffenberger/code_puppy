...
from code_puppy.plugins.claude_plugin_adapter.config import get_claude_plugins_dir, get_installed_plugins
...
def install_plugin(plugin_path_str: str) -> bool:
    ...
    if not source_dir.exists() or not source_dir.is_dir():
        emit_error(f"Cannot install: path {source_dir} does not exist or is not a directory.")
        return False
