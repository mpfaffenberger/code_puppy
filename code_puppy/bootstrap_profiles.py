...
_BUILTIN_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "android-termux-lean": {
        ...
        "notes": [
            ...
            "Avoid browser/image/search extras during initial attach.",
    ...
    "desktop-browser": {
        "description": "Desktop-oriented profile with local browser, image, and search helpers.",
        "extras": ["browser", "images", "search"],
        "notes": [
