...
def cluster_and_embed(
    adata, use_rep=None, n_neighbors=15, resolution=1.0, min_dist=0.3
):
    """
...
Examples:
    ...
    parser.add_argument(
        "--n-neighbors", type=int, default=15, help="Neighbors for graph (default: 15)"
    )
    parser.add_argument(
        "--resolution", type=float, default=1.0, help="Leiden resolution (default: 1.0)"
    )
    parser.add_argument(
        "--min-dist", type=float, default=0.3, help="UMAP min_dist (default: 0.3)"
    )
